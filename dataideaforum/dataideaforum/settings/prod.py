...
# python manage.py runserver --settings=dataideaforum.settings.prod_local
...
SECRET_KEY = os.environ.get("SECRET_KEY", 'django-insecure-kn-m4f81ifin9m##79o1c1acxp-_ixatj7s_wjojk#2wuy@^cw')
